    ...
    <ul class="nav navbar-right top-nav"><!-- nav navbar-right top-nav begin -->
        ...
        <li class="dropdown"><!-- dropdown begin -->
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><!-- dropdown-toggle begin -->
                ...
                <i class="fa fa-user"></i> <?php echo urldecode($admin_name);  ?> <b class="caret"></b>
            ...
            <ul class="dropdown-menu"><!-- dropdown-menu begin -->
                ...
                <li><!-- li begin -->
                    <a href="index.php?view_products"><!-- a href begin -->
                        ...
                        <span class="badge"><?php echo urldecode($count_products); ?></span>
                ...
                <li><!-- li begin -->
                    <a href="index.php?view_customers"><!-- a href begin -->
                        ...
                        <span class="badge"><?php echo urldecode($count_customers); ?></span>
                ...
                <li><!-- li begin -->
                    <a href="index.php?view_cats"><!-- a href begin -->
                        ...
                        <span class="badge"><?php echo urldecode($count_p_categories); ?></span>
