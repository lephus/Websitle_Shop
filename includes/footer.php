    ...
    <div class="container"><!-- container Begin -->
        <div class="row"><!-- row Begin -->
            ...
            <div class="col-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
                ...
                <strong>TNNC.</strong>
                    <br/>cong ty 1 thành viên
                    <br/>
                    <br/>123456789
                    <br/>mugianto4th@gmail.com
                    <br/><strong>Phú Nguyễn</strong>
...
<div id="copyright"><!-- #copyright Begin -->
    <div class="container"><!-- container Begin -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            ...
            <p class="pull-left">&copy; 2020 Store All Rights Reserve</p>
            
        </div><!-- col-md-6 Finish -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            
            <p class="pull-right">Theme by: <a href="#">Phú Nguyễn</a></p>
