       ...
       <div class="container"><!-- container Begin -->
           <div class="col-md-12"><!-- col-md-12 Begin -->
               ...
               <ul class="breadcrumb"><!-- breadcrumb Begin -->
                   ...
                   <li>
                       <a href="shop.php?p_cat=<?php echo $p_cat_id; ?>"><?php echo urldecode($p_cat_title); ?></a>
                   </li>
                   <li> <?php echo urldecode($pro_title); ?> </li>
               ...
               <div id="productMain" class="row"><!-- row Begin -->
                   ...
                   <div class="col-sm-6"><!-- col-sm-6 Begin -->
                       <div class="box"><!-- box Begin -->
                           <h1 class="text-center"> <?php echo urldecode($pro_title); ?> </h1>
                   ...
                   while($row_products=mysqli_fetch_array($run_products)){
                       ...
                       echo "
                        ...
                        <div class='col-md-3 col-sm-6 center-responsive'>
                            ...
                            <div class='product same-height' style = 'height: 310px'>
