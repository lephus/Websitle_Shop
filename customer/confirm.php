               ...
               <div class="box"><!-- box Begin -->
                   ...
                   <?php 
                    ...
                    if(isset($_POST['confirm_payment'])){
                        ...
                        $update_id = urlencode($_GET['update_id']);
                        
                        $invoice_no = urlencode($_POST['invoice_no']);
                        
                        $amount = urlencode($_POST['amount_sent']);
                        
                        $payment_mode = urlencode($_POST['payment_mode']);
                        
                        $ref_no = urlencode($_POST['ref_no']);
                        
                        $code =urlencode( $_POST['code']);
                        
                        $payment_date = urlencode($_POST['date']);
