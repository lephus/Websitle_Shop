...
$customer_name = urldecode($row_customer['customer_name']);

$customer_email = urldecode($row_customer['customer_email']);

$customer_country = urldecode($row_customer['customer_country']);

$customer_city = urldecode($row_customer['customer_city']);

$customer_contact = urldecode($row_customer['customer_contact']);

$customer_address = urldecode($row_customer['customer_address']);

$customer_image = urldecode($row_customer['customer_image']);
